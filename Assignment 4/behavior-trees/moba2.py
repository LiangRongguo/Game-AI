...
class Base(Mover):
	...
	def __init__(self, image, position, world, team = None, minionType = Minion, heroType = Hero, buildrate = BUILDRATE, hitpoints = BASEHITPOINTS2, firerate = BASEFIRERATE, bulletclass = BaseBullet):
